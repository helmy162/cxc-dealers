...
export const AllDefaultValues = (carData) => ( {
  ...
  // Specs
  Fog_Lights: carData?.specs?.Fog_Lights || true,
  Parking_Sensor: carData?.specs?.Parking_Sensor || true,
  Winch: carData?.specs?.Winch || true,
  Roof_Rack: carData?.specs?.Roof_Rack || true,
  Spoiler: carData?.specs?.Spoiler || true,
  Dual_Exhaust: carData?.specs?.Dual_Exhaust || true,
  Alarm: carData?.specs?.Alarm || true,
  Rear_Video: carData?.specs?.Rear_Video || true,
  Premium_Sound: carData?.specs?.Premium_Sound || true,
  Heads_Up_Display: carData?.specs?.Heads_Up_Display || true,
  Aux_Audio: carData?.specs?.Aux_Audio || true,
  Bluetooth: carData?.specs?.Bluetooth || true,
  Climate_Control: carData?.specs?.Climate_Control || true,
  Keyless_Entry: carData?.specs?.Keyless_Entry || true,
  Keyless_Start: carData?.specs?.Keyless_Start || true,
  Leather_Seats: carData?.specs?.Leather_Seats || true,
  Racing_Seats: carData?.specs?.Racing_Seats || true,
  Cooled_Seats: carData?.specs?.Cooled_Seats || true,
  Heated_Seats: carData?.specs?.Heated_Seats || true,
  Power_Seats: carData?.specs?.Power_Seats || true,
  Power_Locks: carData?.specs?.Power_Locks || true,
  Power_Mirrors: carData?.specs?.Power_Mirrors || true,
  Power_Windows: carData?.specs?.Power_Windows || true,
  Memory_Seats: carData?.specs?.Memory_Seats || true,
  View_Camera: carData?.specs?.View_Camera || true,
  Blind_Spot_Indicator: carData?.specs?.Blind_Spot_Indicator || true,
  Anti_Lock: carData?.specs?.Anti_Lock || true,
  Adaptive_Cruise_Control: carData?.specs?.Adaptive_Cruise_Control || true,
  Power_Steering: carData?.specs?.Power_Steering || true,
  Side_Steps: carData?.specs?.Side_Steps || true,
  Carbon_Fiber_Interior: carData?.specs?.Carbon_Fiber_Interior || true,
  Line_Change_Assist: carData?.specs?.Line_Change_Assist || true,
  Park_Assist: carData?.specs?.Park_Assist || true,
  Adaptive_Suspension: carData?.specs?.Adaptive_Suspension || true,
  Height_Control: carData?.specs?.Height_Control || true,
  Navigation_System: carData?.specs?.Navigation_System || true,
  ...
  Sunroof_Type: carData?.specs?.Sunroof_Type || 'sunroof',
  Wheel_Type: carData?.specs?.Wheel_Type || '2wd',
  Other_Features: carData?.specs?.Other_Features || '',

  // Tyres
  FrontLeft: carData?.wheels?.FrontLeft || "",
  FrontRight: carData?.wheels?.FrontRight || "",
